...
@section('head')
    ...
    <link rel="stylesheet" href="{{ url('public/bower_components/bootstrap-fileinput/css/fileinput.css') }}">
    <link rel="stylesheet" href="{{ url('public/bower_components/select2/dist/css/select2.css') }}">
                ...
                <div class="breadcrumbs">
                    <div class="container">
                        <ol class="breadcrumb breadcrumb--ys pull-left">
                            ...
                            <li class="active">{{ trans('dish.update') }} </li>
                        </ol>
                    </div>
                </div>
                                ...
                                @if(count($dish->dishImages) != 0)
                                    @foreach($dish->dishImages as $img)
                                        <div class="col-md-2 remove-images">
                                            ...
                                            <input type="hidden" name="images_update[]" value="{{ $img->id }}">
...
@section('foot')
    ...
    <script src="{{ url('public/bower_components/bootstrap-fileinput/js/fileinput.js') }}" type="text/javascript"></script>
	<script src="{{ url('public/bower_components/bootstrap-fileinput/themes/fa/theme.js') }}" type="text/javascript"></script>
    <script src="{{ url('public/bower_components/popper.js/dist/umd/popper.min.js') }}" type="text/javascript"></script>
    
    <!-- Create Tags with Select2 -->
	<script src="{{ url('public/bower_components/select2/dist/js/select2.full.min.js') }}" type="text/javascript"></script>
