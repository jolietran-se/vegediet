...
// mix.styles(['resources/css/detail/dish_detail.css'], 'public/css/dish_detail.css');
// mix.styles(['resources/css/detail/user.css'], 'public/css/user.css');
mix.styles(['resources/css/detail/categories.css'], 'public/css/categories.css');

mix.js('resources/js/dishes/dish_detail.js', 'public/js');
mix.js('resources/js/dishes/search.js', 'public/js');
